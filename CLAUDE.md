...
- Signing keys are repo secrets: `APK_SIGN_KEY` (EC prime256v1 private
  PEM, matching OpenWrt's own apk build) and `OPKG_SIGN_KEY` (usign private
  key). The matching **public** keys live in
